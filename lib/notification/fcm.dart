...
class Fcm {
  ...
  final imagectrl = StreamController<String>.broadcast();
  final statuts = StreamController<String>.broadcast();
  ...
  void terminatedNotification() async {
    ...
    if (remoteMessage != null) {
      ...
      if (remoteMessage.notification != null) {
        ...
        imagectrl.sink.add(remoteMessage.data['image']);
        statuts.sink.add(remoteMessage.data['status']);
      }
    }
  }
  ...
  void forGroundNotification() {
    FirebaseMessaging.onMessageOpenedApp.listen((event) {
      ...
      if (event.notification != null) {
        ...
        imagectrl.sink.add(event.data['image']);
        statuts.sink.add(event.data['status']);
      }
    });
  }
